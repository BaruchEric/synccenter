...
| `scheduled-sync.ts <folder>` | Inside `synccenter-api` | Serialized, tracked mesh/cloud/return workflow for QNAP cron. Uses the container's API credentials and persistent state; exits nonzero for incomplete jobs. |
